  ...
  return (
    <Section label="hero" id="content" sectionRef={heroRef}>
      ...
      I’m a Full-stack web developer specializing in building (and occasionally designing) exceptional digital experiences.
       I use different technologies such as Javascript, React, Redux, Node.js and Ruby on Rails to transform ideas into real-world
       software applications. I am available for hire.
      </a.p>
