...
const projects = [
  {
    title: 'Payhero Kenya',
    note: 'Pay Hero Kenya: Accept Mobile Money Payments in Kenya.',
    image: '/projects/payhero.png',
    imgDims: { width: '2496 ', height: '1427' },
    description:
      'Payhero is a solution to empower businesses to streamline operations, achieve sustainable growth, and enhance customer communication. With our diverse range of tools such as payment APIs, WhatsApp gateway, e-commerce plugins, email APIs, callback as a service, scheduler service, and developer APIs, businesses can effortlessly accept payments, manage finances, and engage with customers.',
    stack: ['Next.js', 'Redux', 'Express', 'MongoDB', 'Golang'],
    links: {
      github: 'https://github.com/Bria222/',
      live: 'https://payherokenya.com/sps/',
    },
  },
  {
  ...
  },
  {
    ...
    description:
      "A Todo list website created with HTML, Sass and JavaScript that saves user's tasks in Local Storage. This app also allows swapping/reordering of tasks implemented utilizing the Javascript Drag & Drop API",
  ...
  },
  {
    ...
    description:
      'A web application for a company that provides commercial and scientific space travel services, utilizing information from the SpaceX API.',
